...
public class VistaAltaEmpleadoRepartidor extends JPanel implements Vista{
	...
	public VistaAltaEmpleadoRepartidor(){
				...
				public void actionPerformed(ActionEvent e) {  
					...
					if (e.getActionCommand() == "Aceptar") {
						...
						if(!esDni(txtDni.getText())){
							...
							JOptionPane.showMessageDialog (null, "Error. DNI no es valido", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						{
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Un nombre no puede contener numeros", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						if(nombre.length()==0 && datos_correctos){
								
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Campo Nombre no puede estar vacio", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						try
						{
							...
							if (txtTelefono.getText().length() != 9){
								...
								datos_correctos = false;
								JOptionPane.showMessageDialog (null, "Error. En el campo Telefono debe haber un numero de 9 digitos", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtTelefono.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Telefono debe haber un numero", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Telefono esta vacio", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtSueldo.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Sueldo debe haber un numero", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Sueldo esta vacio", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtKm.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Kilometros debe haber un numero", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Kilometros esta vacio", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
	...
	public void update(int evento, Object datos) {
		...
		if(exito != -1){
			...
			JOptionPane.showMessageDialog(null, "Añadido con exito, el id es: " + exito , "Alta Empleado Repartidor", JOptionPane.INFORMATION_MESSAGE);
			
		}else{
			
			JOptionPane.showMessageDialog(null, "Ese empleado ya se encuentra dado de alta en el sistema", "Alta Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
