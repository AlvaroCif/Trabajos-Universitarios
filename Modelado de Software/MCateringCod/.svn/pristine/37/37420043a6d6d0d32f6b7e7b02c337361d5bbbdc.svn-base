...
public class VistaMostrarEmpleado extends JPanel implements Vista{
...
private void listenerButtons(JButton btnBuscar, JButton btnVolver) {
				...
				if (e.getActionCommand() == "Volver") {
					...
					} catch (NumberFormatException e2)
					{
						...
						if (!txtId.getText().isEmpty())
							JOptionPane.showMessageDialog (null, "Error. En el campo ID debe haber un numero", "Mostrar Empleado", JOptionPane.ERROR_MESSAGE);
						else
							JOptionPane.showMessageDialog (null, "Error. El campo ID esta vacio", "Mostrar Empleado", JOptionPane.ERROR_MESSAGE);
					}
	...
	@Override
	public void mostrar() {
		frame = new JFrame("Mostrar Empleado");
	...
	public void update(int evento, Object datos) {
		...
		if ( empleado != null ){
			...
			this.btnBuscar.setVisible(false);
				...
				JOptionPane.showMessageDialog(null, "No existe el empleado", "Mostar Empleado", JOptionPane.ERROR_MESSAGE);
