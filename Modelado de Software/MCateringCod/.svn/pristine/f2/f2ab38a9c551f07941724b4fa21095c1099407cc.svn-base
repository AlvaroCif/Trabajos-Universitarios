...
public class VistaAsignarEmpleado extends JPanel implements Vista {
	...
	public VistaAsignarEmpleado(){
		...
		lblHoras.setFont(new java.awt.Font("Courier New", 0, 12));
		lblHoras.setHorizontalAlignment(JLabel.CENTER);
		panel.add(lblHoras);
		
		txtHoras = new JTextField();
		txtHoras.setFont(new java.awt.Font("Courier New", 0, 12));
					...
					if (e.getActionCommand() == "Aceptar") {
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtIdEvento.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo ID Evento debe haber un numero", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo ID Evento esta vacio", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtIdEmpleado.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo ID Empleado debe haber un numero", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo ID Empleado esta vacio", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtHoras.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo horas debe haber un numero", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo horas esta vacio", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
						}
	...
	public void mostrar() {
		...
		frame = new JFrame("Asignar Empleado");
	...
	public void update(int evento, Object datos) {
		...
		{
			case 0:	
				JOptionPane.showMessageDialog(null, "Asignado con exito", "Asignar Empleado", JOptionPane.INFORMATION_MESSAGE);
				frame.dispose();
				break;
			case 1:
				JOptionPane.showMessageDialog(null, "Ya se encuentra asignado el empleado al evento", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
				break;
			case 2:
				JOptionPane.showMessageDialog(null, "El evento o el empleado no se encuentran activos", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
				break;
			case 3:
				JOptionPane.showMessageDialog(null, "El evento no existe", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
				break;
			case 4:
				JOptionPane.showMessageDialog(null, "El empleado no existe", "Asignar Empleado", JOptionPane.ERROR_MESSAGE);
				break;
		}
	}
