...
public class VistaModificarClienteParticular extends JPanel implements Vista{
	...
	public VistaModificarClienteParticular() {
				...
				{  
					...
					if (e.getActionCommand() == "Aceptar") 
					{
						...
						else
						{
							...
							JOptionPane.showMessageDialog (null, "Error. El formato del DNI no es correcto", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
						}
						...
						{
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Un nombre no puede contener numeros", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e1)
						{
							...
							if (!txtId.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo id debe haber un numero", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo id esta vacio", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtTelefono.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo telefono debe haber un numero", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo telefono esta vacio", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
						}
						if (telefono != -1 && txtTelefono.getText().length() != 9)
						{
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. El campo telefono debe tener 9 digitos");
						}
						...
						{
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Un apellido no puede contener numeros", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
						}
	...
	public void mostrar() {
		...
		frame = new JFrame("Modificar Cliente Particular");
	...
	public void update(int evento, Object datos){
		...
		if(exito){
			...
			JOptionPane.showMessageDialog(null, "El cliente ha sido modificado con exito", "Modificar Cliente Particular", JOptionPane.INFORMATION_MESSAGE);
			
		}else{
			
			JOptionPane.showMessageDialog(null, "La operación no se pudo llevar a cabo", "Modificar Cliente Particular", JOptionPane.ERROR_MESSAGE);
