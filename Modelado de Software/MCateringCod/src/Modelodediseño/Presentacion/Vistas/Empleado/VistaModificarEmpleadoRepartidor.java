...
public class VistaModificarEmpleadoRepartidor extends JPanel implements Vista{
	...
	public VistaModificarEmpleadoRepartidor(){
...
boolean datos_correctos = true;
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtId.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo ID debe haber un numero", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo ID esta vacio", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						
						if(!esDni(txtDni.getText())){
							
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. DNI no es valido", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						{
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Un nombre no puede contener numeros", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						if(nombre.length()==0 && datos_correctos){
								
							datos_correctos = false;
							JOptionPane.showMessageDialog (null, "Error. Campo Nombre no puede estar vacio", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						try
						{
							...
							if (txtTelefono.getText().length() != 9){
								...
								datos_correctos = false;
								JOptionPane.showMessageDialog (null, "Error. En el campo Telefono debe haber un numero de 9 digitos", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtTelefono.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Telefono debe haber un numero", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Telefono esta vacio", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtSueldo.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Sueldo debe haber un numero", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Sueldo esta vacio", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						try
						{
						...
						} catch (NumberFormatException e2)
						{
							...
							if (!txtKm.getText().isEmpty())
								JOptionPane.showMessageDialog (null, "Error. En el campo Kilometros debe haber un numero", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
							else
								JOptionPane.showMessageDialog (null, "Error. El campo Kilometros esta vacio", "Modificar Empleado Repartidor", JOptionPane.ERROR_MESSAGE);
						}
						
						if(datos_correctos){
							
							EmpleadoRepartidor empleadoR = new EmpleadoRepartidor();
							empleadoR.setId(id);
							empleadoR.setDni(dni);
							empleadoR.setNombre(nombre);
							empleadoR.setSueldo(sueldo);
							empleadoR.setTelefono(telefono);
							empleadoR.setKm(km);
							empleadoR.setActivo(true);
							
							datos = (Object) empleadoR;
							id_evento = 55;
	...
	@Override
	public void mostrar() {
		frame = new JFrame("Alta Empleado Repartidor");
	...
	public void update(int evento, Object datos) {
		...
		switch(resultado)
		{
			...
			case 4:
				JOptionPane.showMessageDialog(null, "Los tipos de empleado no se corresponden", "Modificar Empleado", JOptionPane.ERROR_MESSAGE);
				break;
		}
